...
import com.app.nearbyble.databinding.BleClientListItemBinding
...
class BleDevicesAdapter(private val clickListener: BleDevicesListener) : ListAdapter<BleDevice,
    ...
    class ViewHolder private constructor(private val binding: BleClientListItemBinding) :
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = BleClientListItemBinding.inflate(layoutInflater, parent, false)
